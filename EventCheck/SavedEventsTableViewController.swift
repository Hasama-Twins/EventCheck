...
class SavedEventsTableViewController: UITableViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        query.limit = 20
        query.whereKey("isregistered", equalTo: true)
        query.order(byAscending: "datetime")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "SavedEventsTableViewCell") as! SavedEventsTableViewCell
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let eventDetailsViewController = segue.destination as! MyEventDetailsViewController
